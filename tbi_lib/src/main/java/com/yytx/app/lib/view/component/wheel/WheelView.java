...
package com.yytx.app.lib.view.component.wheel;
...
import com.yytx.app.lib.view.component.wheel.adapters.WheelViewAdapter;
...
//		centerDrawable.draw(canvas);
		...
		paint.setColor(getResources().getColor(R.color.line_border_color));
		// 设置线宽
